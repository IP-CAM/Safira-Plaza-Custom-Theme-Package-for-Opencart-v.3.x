...
class ControllerExtensionModulePtcontrolpanel extends Controller
{
    ...
    public function index() {
        ...
        $data['layouts'] = array(
            array(
                'skin' => 1,
                'directory' => 'tt_safira_cosmetic1',
                'database' => DIR_APPLICATION . '../plazadata/plaza_db1.sql',
                'title' => 'Layout Cosmetic 1',
                'preview' => $common_url . 'image/plaza/preview/layout/cosmetic1.jpg'
            ),
            array(
                'skin' => 2,
                'directory' => 'tt_safira_cosmetic2',
                'database' => DIR_APPLICATION . '../plazadata/plaza_db2.sql',
                'title' => 'Layout Cosmetic 2',
                'preview' => $common_url . 'image/plaza/preview/layout/cosmetic2.jpg'
            ),
            array(
                'skin' => 3,
                'directory' => 'tt_safira_cosmetic3',
                'database' => DIR_APPLICATION . '../plazadata/plaza_db3.sql',
                'title' => 'Layout Cosmetic 3',
                'preview' => $common_url . 'image/plaza/preview/layout/cosmetic3.jpg'
            ),
            array(
                'skin' => 4,
                'directory' => 'tt_safira_cosmetic4',
                'database' => DIR_APPLICATION . '../plazadata/plaza_db4.sql',
                'title' => 'Layout Cosmetic 4',
                'preview' => $common_url . 'image/plaza/preview/layout/cosmetic4.jpg'
            ),
        );
        ...
        $data['headers'] = array(
            array(
                'value' => 1,
                'preview' => $common_url . 'image/plaza/preview/header/cosmetic_header1.jpg'
            ),
            array(
                'value' => 2,
                'preview' => $common_url . 'image/plaza/preview/header/cosmetic_header2.jpg'
            ),
            array(
                'value' => 3,
                'preview' => $common_url . 'image/plaza/preview/header/cosmetic_header3.jpg'
            ),
            array(
                'value' => 4,
                'preview' => $common_url . 'image/plaza/preview/header/cosmetic_header4.jpg'
            ),
        );
