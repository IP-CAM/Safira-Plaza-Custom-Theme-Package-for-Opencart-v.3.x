...
class ControllerExtensionModulePtcontrolpanel extends Controller
{
    ...
    public function index() {
        ...
        $data['layouts'] = array(
            array(
                'skin' => 1,
                'directory' => 'tt_safira_marketplace1',
                'database' => DIR_APPLICATION . '../plazadata/plaza_db1.sql',
                'title' => 'Layout Marketplace 1',
                'preview' => $common_url . 'image/plaza/preview/layout/marketplace1.jpg'
            ),
            array(
                'skin' => 2,
                'directory' => 'tt_safira_marketplace2',
                'database' => DIR_APPLICATION . '../plazadata/plaza_db2.sql',
                'title' => 'Layout Marketplace 2',
                'preview' => $common_url . 'image/plaza/preview/layout/marketplace2.jpg'
            ),
            array(
                'skin' => 3,
                'directory' => 'tt_safira_marketplace3',
                'database' => DIR_APPLICATION . '../plazadata/plaza_db3.sql',
                'title' => 'Layout Marketplace 3',
                'preview' => $common_url . 'image/plaza/preview/layout/marketplace3.jpg'
            ),
            array(
                'skin' => 4,
                'directory' => 'tt_safira_marketplace4',
                'database' => DIR_APPLICATION . '../plazadata/plaza_db4.sql',
                'title' => 'Layout Marketplace 4',
                'preview' => $common_url . 'image/plaza/preview/layout/marketplace4.jpg'
            ),
        );
        ...
        $data['headers'] = array(
            array(
                'value' => 1,
                'preview' => $common_url . 'image/plaza/preview/header/marketplace_header1.jpg'
            ),
            array(
                'value' => 2,
                'preview' => $common_url . 'image/plaza/preview/header/marketplace_header2.jpg'
            ),
            array(
                'value' => 3,
                'preview' => $common_url . 'image/plaza/preview/header/marketplace_header3.jpg'
            ),
            array(
                'value' => 4,
                'preview' => $common_url . 'image/plaza/preview/header/marketplace_header4.jpg'
            ),
        );
