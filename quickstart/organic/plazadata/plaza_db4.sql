...
UPDATE `oc_setting` SET `value` = 'Safira Organic 4' WHERE `oc_setting`.`key` = 'config_name' AND store_id = 0;
UPDATE `oc_setting` SET `value` = 'Safira Organic 4' WHERE `oc_setting`.`key` = 'config_meta_description' AND store_id = 0;
