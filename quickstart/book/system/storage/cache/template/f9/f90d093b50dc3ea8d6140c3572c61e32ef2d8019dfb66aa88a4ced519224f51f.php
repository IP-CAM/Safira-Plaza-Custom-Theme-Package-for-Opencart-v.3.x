...
class __TwigTemplate_5db3d37021fa30139a568c15d1dced67dca8a79877b6ba63c6b960d7331c155c extends \Twig\Template
{
    private $source;
    private $macros = [];
...
\t\t\t\t\$(tab).closest('.tab-content').find('.tab-product').hide();
                \$(tab).show();
\t\t\t\t\$('.product-tabs-section .tab-content img').lazyload();
            });
        </script>
        ";
        }
