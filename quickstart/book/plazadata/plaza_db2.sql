...
(938, 18, 0, 'common/home'),
(940, 17, 0, 'plaza/blog/post'),
(941, 16, 0, 'account/%'),
(937, 22, 0, ''),
(942, 21, 0, 'product/category'),
(939, 20, 0, 'product/product'),
(920, 19, 0, 'plaza/responsive/mobile');
-- --------------------------------------------------------
...
( 0, 'module_ptcontrolpanel', 'module_ptcontrolpanel_header_layout', '[\"2\",\"2\",\"3\",\"4\"]', 1);
UPDATE `oc_setting` SET `value` = '22' WHERE `oc_setting`.`key` = 'config_layout_id' AND store_id = 0;
UPDATE `oc_setting` SET `value` = 'tt_safira_book2' WHERE `oc_setting`.`key` = 'theme_default_directory' AND store_id = 0;
