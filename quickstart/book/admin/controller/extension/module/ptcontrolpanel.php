...
class ControllerExtensionModulePtcontrolpanel extends Controller
{
    ...
    public function index() {
        ...
        $data['layouts'] = array(
            array(
                'skin' => 1,
                'directory' => 'tt_safira_book1',
                'database' => DIR_APPLICATION . '../plazadata/plaza_db1.sql',
                'title' => 'Layout Book Theme 1',
                'preview' => $common_url . 'image/plaza/preview/layout/book1.jpg'
            ),
            array(
                'skin' => 2,
                'directory' => 'tt_safira_book2',
                'database' => DIR_APPLICATION . '../plazadata/plaza_db2.sql',
                'title' => 'Layout Book Theme 2',
                'preview' => $common_url . 'image/plaza/preview/layout/book2.jpg'
            ),
            array(
                'skin' => 3,
                'directory' => 'tt_safira_book3',
                'database' => DIR_APPLICATION . '../plazadata/plaza_db3.sql',
                'title' => 'Layout Book Theme 3',
                'preview' => $common_url . 'image/plaza/preview/layout/book3.jpg'
            ),
            array(
                'skin' => 4,
                'directory' => 'tt_safira_book4',
                'database' => DIR_APPLICATION . '../plazadata/plaza_db4.sql',
                'title' => 'Layout Book Theme 4',
                'preview' => $common_url . 'image/plaza/preview/layout/book4.jpg'
            ),
        );
        ...
        $data['headers'] = array(
            array(
                'value' => 1,
                'preview' => $common_url . 'image/plaza/preview/header/book_header1.jpg'
            ),
            array(
                'value' => 2,
                'preview' => $common_url . 'image/plaza/preview/header/book_header2.jpg'
            ),
            array(
                'value' => 3,
                'preview' => $common_url . 'image/plaza/preview/header/book_header3.jpg'
            ),
            array(
                'value' => 4,
                'preview' => $common_url . 'image/plaza/preview/header/book_header4.jpg'
            ),
        );
