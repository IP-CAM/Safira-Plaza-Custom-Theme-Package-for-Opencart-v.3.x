...
/* tt_safira_jewelry1/template/plaza/filter/category.twig */
class __TwigTemplate_1096493a635f12632de5451a9fc81871b34d05989c7bd675679d72c3778e6ab1 extends \Twig\Template
{
    private $source;
    private $macros = [];
...
\t\t\t\t\t\t\t\t\t\t<button type=\"button\" class=\"button-cart\"  title=\"";
                    ...
                    echo "', '";
                    echo twig_get_attribute($this->env, $this->source, $context["product"], "minimum", [], "any", false, false, false, 214);
                    echo "');\"><span>";
                    echo ($context["button_cart"] ?? null);
                    echo "</span></button>
\t\t\t\t\t\t\t\t\t</div>
...
<script type=\"text/javascript\">
    ...
    {
        return "tt_safira_jewelry1/template/plaza/filter/category.twig";
    }
