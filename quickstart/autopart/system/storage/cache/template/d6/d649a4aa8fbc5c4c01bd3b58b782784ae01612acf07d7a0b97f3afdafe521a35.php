...
/* tt_safira_sportswear2/template/plaza/module/ptproducts.twig */
class __TwigTemplate_2b6256306684689dfc3c836f2b1b747b06616b2de366c39faf4badd6f7831b68 extends \Twig\Template
{
    private $source;
    private $macros = [];
...
\t\t\t\t\$(tab).closest('.tab-content').find('.tab-product').hide();
    ...
    {
        return "tt_safira_sportswear2/template/plaza/module/ptproducts.twig";
    }
    ...
    {
        return new Source("", "tt_safira_sportswear2/template/plaza/module/ptproducts.twig", "");
    }
}
