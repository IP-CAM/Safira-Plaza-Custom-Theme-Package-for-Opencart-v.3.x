...
/* tt_safira_sportswear1/template/plaza/module/ptproducts.twig */
class __TwigTemplate_ad7f728d2a5821c563cee28cc03a62068d4eef49731cdf548e9d5ebbc4ab852c extends \Twig\Template
{
    private $source;
    private $macros = [];
...
\t\t\t\t\$(tab).closest('.tab-content').find('.tab-product').hide();
    ...
    {
        return "tt_safira_sportswear1/template/plaza/module/ptproducts.twig";
    }
    ...
    {
        return new Source("", "tt_safira_sportswear1/template/plaza/module/ptproducts.twig", "");
    }
}
