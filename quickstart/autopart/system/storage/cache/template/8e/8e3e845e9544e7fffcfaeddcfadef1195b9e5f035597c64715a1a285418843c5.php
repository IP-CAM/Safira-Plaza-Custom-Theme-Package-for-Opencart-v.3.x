...
/* tt_safira_sportswear3/template/product/product.twig */
class __TwigTemplate_fb7d3e09ae74dd8c44387a2ea2f5aea5478add6890a00be50b5f367ee8ad7204 extends \Twig\Template
{
    private $source;
    private $macros = [];
...
\t\t\t\t\t\t\t\t\t\t\t\t\t\t<button class=\"button-cart\" type=\"button\"  title=\"";
                ...
                echo twig_get_attribute($this->env, $this->source, $context["product"], "product_id", [], "any", false, false, false, 619);
                echo "', '";
                echo twig_get_attribute($this->env, $this->source, $context["product"], "minimum", [], "any", false, false, false, 619);
                echo "');\"><span>";
                echo ($context["button_cart"] ?? null);
                echo "</span></button>
\t\t\t\t\t\t\t\t\t\t\t\t\t</div>
...
";
    ...
    {
        return "tt_safira_sportswear3/template/product/product.twig";
    }
