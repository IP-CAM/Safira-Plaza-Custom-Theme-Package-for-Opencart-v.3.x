...
/* tt_safira_medical1/template/plaza/blog/list.twig */
class __TwigTemplate_a913f9fe9bb8fed41fda4310ba21489fe4fac3dfff6ba1de676b992440c3f57d extends \Twig\Template
{
    private $source;
    private $macros = [];
...
\t\t\t\t\t\t\t\t\t\t\t\t\t\t<span class=\"post-date\">";
                    // line 65
                    echo twig_get_attribute($this->env, $this->source, $context["post"], "date_added", [], "any", false, false, false, 65);
                    echo "</span>
\t\t\t\t\t\t\t\t\t\t\t\t\t\t<span class=\"post-author\">";
                    // line 66
                    if (twig_get_attribute($this->env, $this->source, $context["post"], "author", [], "any", false, false, false, 66)) {
                        echo twig_get_attribute($this->env, $this->source, $context["post"], "author", [], "any", false, false, false, 66);
                    }
                    echo "</span>
\t\t\t\t\t\t\t\t\t\t\t\t\t</div>
\t\t\t\t\t\t\t\t\t\t\t\t\t<h4 class=\"post-name\"><a  href=\"";
                    // line 68
                    echo twig_get_attribute($this->env, $this->source, $context["post"], "href", [], "any", false, false, false, 68);
                    echo "\">";
                    echo twig_get_attribute($this->env, $this->source, $context["post"], "name", [], "any", false, false, false, 68);
                    echo "</a></h4>
\t\t\t\t\t\t\t\t\t\t\t\t\t<div class=\"post-intro\">";
                    // line 69
                    echo twig_get_attribute($this->env, $this->source, $context["post"], "intro_text", [], "any", false, false, false, 69);
                    echo "</div>
\t\t\t\t\t\t\t\t\t\t\t\t\t<div class=\"btn-more\"><a href=\"";
                    // line 70
                    echo twig_get_attribute($this->env, $this->source, $context["post"], "href", [], "any", false, false, false, 70);
                    echo "\">";
...
\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t<span class=\"post-date\">";
                    // line 90
                    echo twig_get_attribute($this->env, $this->source, $context["post"], "date_added", [], "any", false, false, false, 90);
                    echo "</span>
\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t<span class=\"post-author\">";
                    // line 91
                    if (twig_get_attribute($this->env, $this->source, $context["post"], "author", [], "any", false, false, false, 91)) {
                        echo twig_get_attribute($this->env, $this->source, $context["post"], "author", [], "any", false, false, false, 91);
                    }
                    echo "</span>
\t\t\t\t\t\t\t\t\t\t\t\t\t\t</div>
\t\t\t\t\t\t\t\t\t\t\t\t\t</div>
...
";
    ...
    {
        return "tt_safira_medical1/template/plaza/blog/list.twig";
    }
