...
class __TwigTemplate_238b065b0e29ee4aa3b40585324171e7a4af324ea8e58c32169db3efd0da8dfb extends \Twig\Template
{
    private $source;
    private $macros = [];
...
\t\t\t\t\t\t\t\t\t\t\t\t\t\t<button class=\"button-cart\" type=\"button\"  title=\"";
                ...
                echo "', '";
                echo twig_get_attribute($this->env, $this->source, $context["product"], "minimum", [], "any", false, false, false, 620);
                echo "');\"><span>";
                echo ($context["button_cart"] ?? null);
                echo "</span></button>
\t\t\t\t\t\t\t\t\t\t\t\t\t\t</div>
