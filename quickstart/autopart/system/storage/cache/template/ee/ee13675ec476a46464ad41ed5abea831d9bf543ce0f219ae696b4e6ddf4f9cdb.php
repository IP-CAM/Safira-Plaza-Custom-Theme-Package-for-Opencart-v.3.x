...
/* tt_safira_sportswear4/template/plaza/module/ptproducts.twig */
class __TwigTemplate_512be9f453f4d1d3e6566cdffc89e2633c8753afe80e9d2b5c3ca6b8e2ae470c extends \Twig\Template
{
    private $source;
    private $macros = [];
...
\t\t\t\t\$(tab).closest('.tab-content').find('.tab-product').hide();
    ...
    {
        return "tt_safira_sportswear4/template/plaza/module/ptproducts.twig";
    }
    ...
    {
        return new Source("", "tt_safira_sportswear4/template/plaza/module/ptproducts.twig", "");
    }
}
