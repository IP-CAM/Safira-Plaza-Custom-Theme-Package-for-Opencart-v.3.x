...
/* tt_safira_furniture1/template/plaza/module/ptproducts.twig */
class __TwigTemplate_52804165c0cce30b6104fbe95ff58b698f883cd1c471acffc81eddc3eba1f114 extends \Twig\Template
{
    private $source;
    private $macros = [];
...
\t\t\t\t\t\t\t\t\t";
                    // line 18
                    if (twig_get_attribute($this->env, $this->source, $context["tab"], "title_image", [], "any", false, false, false, 18)) {
                        // line 19
...
\t\t\t\t\$(tab).closest('.tab-content').find('.tab-product').hide();
    ...
    {
        return "tt_safira_furniture1/template/plaza/module/ptproducts.twig";
    }
