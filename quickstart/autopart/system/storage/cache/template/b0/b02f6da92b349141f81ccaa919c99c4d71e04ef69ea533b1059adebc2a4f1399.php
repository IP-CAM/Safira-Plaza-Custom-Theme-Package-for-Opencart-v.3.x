...
/* tt_safira_sportswear1/template/plaza/module/ptblog.twig */
class __TwigTemplate_0f83180f4edb24d8956bcc1f6beaa9e8bbca08a581bb88842cb9f565d2057715 extends \Twig\Template
{
    private $source;
    private $macros = [];
...
\t\t\t\t\t\t\t\t\t\t\t<h4 class=\"post-name\"><a  href=\"";
                ...
                echo "\">";
                echo twig_get_attribute($this->env, $this->source, $context["post"], "name", [], "any", false, false, false, 30);
                echo "</a></h4>
\t\t\t\t\t\t\t\t\t\t\t<div class=\"post-intro\">";
                // line 31
                echo twig_get_attribute($this->env, $this->source, $context["post"], "intro_text", [], "any", false, false, false, 31);
                echo "</div>
...
";
        ...
        \$(\".posts-container\").swiper({
            ...
            // line 65
            echo "            ";
            if (twig_get_attribute($this->env, $this->source, ($context["slide"] ?? null), "navigation", [], "any", false, false, false, 65)) {
                // line 66
            ...
            // line 69
            echo "            speed: ";
            if (twig_get_attribute($this->env, $this->source, ($context["slide"] ?? null), "speed", [], "any", false, false, false, 69)) {
                echo " ";
                echo twig_get_attribute($this->env, $this->source, ($context["slide"] ?? null), "speed", [], "any", false, false, false, 69);
                echo " ";
            } else {
                echo " 500 ";
            }
            ...
            slidesPerView: ";
            // line 70
            echo twig_get_attribute($this->env, $this->source, ($context["slide"] ?? null), "items", [], "any", false, false, false, 70);
            echo ",
            slidesPerColumn: ";
            // line 71
            echo twig_get_attribute($this->env, $this->source, ($context["slide"] ?? null), "rows", [], "any", false, false, false, 71);
            echo ",
\t\t\twatchSlidesVisibility: true,
            autoplay: ";
            // line 73
            if (twig_get_attribute($this->env, $this->source, ($context["slide"] ?? null), "auto", [], "any", false, false, false, 73)) {
                echo " 3000 ";
            } else {
                echo " false ";
            }
...
";
    ...
    {
        return "tt_safira_sportswear1/template/plaza/module/ptblog.twig";
    }
    ...
    {
        return array (  212 => 73,  207 => 71,  203 => 70,  192 => 69,  187 => 66,  184 => 65,  179 => 62,  177 => 61,  172 => 58,  170 => 57,  166 => 55,  160 => 53,  156 => 51,  149 => 46,  147 => 45,  144 => 44,  140 => 42,  138 => 41,  134 => 39,  119 => 32,  115 => 31,  109 => 30,  102 => 28,  98 => 27,  83 => 21,  77 => 17,  73 => 16,  68 => 13,  66 => 12,  62 => 10,  56 => 8,  54 => 7,  49 => 6,  43 => 4,  41 => 3,  37 => 1,);
    }

    public function getSourceContext()
    {
        return new Source("", "tt_safira_sportswear1/template/plaza/module/ptblog.twig", "");
    }
}
