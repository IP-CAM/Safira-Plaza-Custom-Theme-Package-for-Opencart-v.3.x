...
/* tt_safira_sportswear3/template/plaza/module/ptproducts.twig */
class __TwigTemplate_1fa11f5659c71a0babe4f3b651b37b0b64ce75b185976ffca6a6025d62cae4a0 extends \Twig\Template
{
    private $source;
    private $macros = [];
...
\t\t\t\t\$(tab).closest('.tab-content').find('.tab-product').hide();
    ...
    {
        return "tt_safira_sportswear3/template/plaza/module/ptproducts.twig";
    }
    ...
    {
        return new Source("", "tt_safira_sportswear3/template/plaza/module/ptproducts.twig", "");
    }
}
