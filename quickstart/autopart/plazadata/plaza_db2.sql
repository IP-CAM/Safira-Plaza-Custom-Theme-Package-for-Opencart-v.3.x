...
( 0, 'module_ptcontrolpanel', 'module_ptcontrolpanel_header_layout', '["2"]', 1),
...
UPDATE `oc_setting` SET `value` = '22' WHERE `oc_setting`.`key` = 'config_layout_id';
...
UPDATE `oc_setting` SET `value` = 'tt_safira_autopart2' WHERE `oc_setting`.`key` = 'theme_default_directory';
